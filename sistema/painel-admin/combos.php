...
<div class="row mt-4 mb-4">
  <a type="button" class="btn-primary btn-sm ml-3 d-none d-md-block p-2" href="index.php?pag=<?php echo $pag ?>&funcao=novo">Cadastrar Novo Combo</a>
      ...
      <table class="w3-table-all w3-hoverable table table-striped table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
         ...
         for ($i=0; $i < count($res); $i++) { 
          ...
          // CLASSE PARA MUDAR DE COR O BOTAO ATIVO OU INATIVO
          $classe = "";
          if($ativo == "Sim"){
            $classe = "text-success";
          }else{
          ...
          <tr>
            <td>
              ...
              <a href="../../combo-<?php echo $nome_url; ?>" class="text-info" target='blank'>
                <?php echo $nome ?>
              </a>

            </td>
            <td>R$ <?php echo $valor ?></td>
            <td id="quantidade-produtos"><?php echo $total_produtos ?></td>
            ...
            <td>
             ...
             <a href="index.php?pag=<?php echo $pag ?>&funcao=produtos&id=<?php echo $id ?>" class='text-danger mr-1 ' title='Inserir Produtos'><i class="fas fa-plus-circle" style="color: #013ca2;"></i></a>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"  id="fechar-modal-produtos">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
                ...
                <tbody>
                  ...
                  for ($i=0; $i < count($res); $i++) { 
                    ...
                    <tr>
                      ...
                      <a href="../../produto-<?php echo $nome_url2; ?>" class="text-info" target='blank'>
                      <?php echo $nome_prod ?>
                       </a>
                      ...
                      <td>
                        ...
                        <form id="form-prod" method="post">
                          ...
                          <a id="btn-add-produtos" href="#" onClick="addProd(<?php echo $id_prod ?>)" class="text-success mr-1 col-sm-1" title="Adicionar Produto"><i class="fas fa-plus-circle" style="color: #013ca2;"></i></a>
...
<!-- SCRIPT PARA ATULIZAR A QUANTIDADE DE PRODUTOS QUANTO FECHAR O MODAL DE INSERÇAO -->
<script type="text/javascript">
function atualizarQtProdutos(valor){
  var tdQuantidade = document.getElementById('quantidade-produtos');
    var total_produtos = valor;
    tdQuantidade.textContent = total_produtos;
