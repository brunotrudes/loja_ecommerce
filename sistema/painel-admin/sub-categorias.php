            ...
            <table class="w3-table-all w3-hoverable table table-striped table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                   ...
                   for ($i=0; $i < count($res); $i++) { 
                      ...
                      //recuperar o nome da categoria e nao o id
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                if (@$_GET['funcao'] == 'editar') {
                    ...
                    // tras o registro da categoria atraves do relacionamento entre as tabelas
            ...
            <form id="form" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                     ...
                     <!-- campo select para trazer as categorias -->
                        ...
                        <select class="form-control form-control-sm" name="categoria" id="categoria">
                            <?php 
                                ...
                                // listando as categorias ja cadastradas
