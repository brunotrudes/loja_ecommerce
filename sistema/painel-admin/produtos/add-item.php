...
$estoque_item= $_POST['estoque-item'];
$id_produto = $_POST['id_carac_item'];
...
if($estoque_item == ""){
	echo 'Preencha o estoque para o item!';
	exit();
}
...
$pdo->query("INSERT INTO carac_itens (id_carac_prod, nome, valor_item, ativo, valor, estoque) VALUES ('$id_carac_prod', '$nome_item', '$valor_item', 'Sim', '$acrescimo_item', '$estoque_item')");
