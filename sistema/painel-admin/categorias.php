...
<!-- ajustando o botao categoria para mobile e desktop -->
        ...
        <div class="table-responsive">
            <table class="w3-table-all w3-hoverable table table-striped table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                   ...
                   <?php 
                    // busca a tabela categorias e ordena por ordem de id - verificar script para previnir ordenamento por data table
                   ...
                   for ($i=0; $i < count($res); $i++) { 
                    ...
                    <tr>
                      ...
                      <!-- passa o id da categoria para editar quando abrir o modal -->
                        <td> 
...
<!-- Modal - edição de dados das categorias-->
        ...
        <div class="modal-content">
            ...
            <form id="form" method="POST">
                ...
                <div class="modal-footer">
                        ...
                        <!-- puxando registro antigo de categorias pra nao salvar a mesma novamente -->
...
<!-- script para previnir ordenamento do data table -->
