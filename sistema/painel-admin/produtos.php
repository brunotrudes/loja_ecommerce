...
<div class="card shadow mb-4 ">
  ...
  <div class="card-body ">
    <div class=" tabela-responsiva table-responsive table-responsive{-sm|-md|-lg|-xl}">
      
        <table class="table table-bordered w3-table-all w3-hoverable  table-striped  " id="dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            for ($i = 0; $i < count($res); $i++) {
                ...
                $id = $res[$i]['id'];
                $variavel = $res[$i]['variavel'];
                $valor = number_format($valor, 2, ',', '.');
                //recuperar o nome da categoria
                $query2 = $pdo->query(
                    "SELECT * from sub_categorias where id = '$sub_cat' "
                );
              ...
              <tr class="fw-bold">
                <td data-title="Nome">
                  ...
                  <a href="../../produto-<?php echo $nome_url; ?>" class="text-info" target='blank'>
                    <?php echo $nome; ?>
                  </a>
                </td>
                <td data-title="SKU"><?php echo $sku; ?></td>
                <td data-title="Valor">R$ <?php echo $valor; ?></td>
                <td data-title="Estoque"><?php echo $estoque; ?></td>
                <td data-title="Sub Categoria"><?php echo $nome_cat; ?></td>
                <td data-title="Imagem"><img src="../../img/produtos/<?php echo $imagem; ?>" width="50"></td>
        
                <td data-title="Ações">
                  <a href="index.php?pag=<?php echo $pag; ?>&funcao=editar&id=<?php echo $id; ?>" class='text-primary mr-1 icon-menu' title='Editar Dados'><i class='far fa-edit'></i></a>
                  <a href="index.php?pag=<?php echo $pag; ?>&funcao=excluir&id=<?php echo $id; ?>" class='text-danger mr-1 icon-menu' title='Excluir Registro'><i class='far fa-trash-alt'></i></a>
                  <a href="index.php?pag=<?php echo $pag; ?>&funcao=imagens&id=<?php echo $id; ?>" class='text-info mr-1 icon-menu' title='Inserir Imagens'><i class='fas fa-images'></i></a>
        
                    <a href="index.php?pag=<?php echo $pag; ?>&funcao=carac&id=<?php echo $id; ?>" class="text-secondary icon-menu" id="carac-icon" title='Características'>
                    <?php if ($variavel == 'Sim') {
                        echo "<i class='fas fa-table text-success' title='Produto Variável'></i>";
                    } else {
                        echo "<i class='fas fa-table text-secundary' title='Produto Simples'></i>";
                    } ?>
                 </a>
                  <a href="index.php?pag=<?php echo $pag; ?>&funcao=promocao&id=<?php echo $id; ?>" class=' mr-1 icon-menu' title='Adicionar Promoção'>
                    <?php if ($promocao == 'Sim') {
    ...
    <div class="modal-content">
      <div class="modal-header">
        <?php if (@$_GET['funcao'] == 'editar') {
            ...
            $query = $pdo->query(
                "SELECT * FROM produtos where id = '" . $id2 . "' "
            );
            $res = $query->fetchAll(PDO::FETCH_ASSOC);
      ...
      <form id="form" method="POST">
        <div class="modal-body">
          ...
          <div class="row">
              ...
              <div class="form-group">
                ...
                <select class="form-control form-control-sm" name="categoria" id="categoria">
                  ...
                  if (@$_GET['funcao'] == 'editar') {
                      $query = $pdo->query(
                          "SELECT * from categorias where id = '$nome_cat2' "
                      );
                      $res = $query->fetchAll(PDO::FETCH_ASSOC);
                      $nomeCat = $res[0]['nome'];
                      echo "<option value='" .
                  ...
                  <!-- input hidden que recebera os dados do filtros da subcategoria -->
                </select>
            ...
            <div class="col-md-2">
              <div class="form-group">
                <label>SKU</label>
                <span></span>
                <input value="<?php echo @$sku2; ?>" type="text" class="form-control form-control-sm" id="sku" name="sku" placeholder="SKU">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control form-control-sm" id="descricao_longa" name="descricao_longa" style="height: 200px;"><?php echo @$desc_longa2; ?></textarea>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label>Valor</label>
                <input value="R$ <?php echo @$valor2; ?>" type="text" class="form-control form-control-sm" id="valor" name="valor" placeholder="Valor">
              </div>
            </div>
            <div class="col-md-2">
                ...
                <label>Em Promoção</label>
                    ...
                    <a href="index.php?pag=<?php echo $pag; ?>&funcao=promocao&id=<?php echo $id2; ?>" class=' mr-1 icon-menu' title='Adicionar Promoção'>
                    <?php if (@$promocao2 == 'Sim') {
                        echo "<i class='fas fa-coins text-success'></i>";
                    } else {
                        echo "<i class='fas fa-coins text-danger'></i>";
                    } ?>
                  </a>
                <input value="<?php echo @$promocao2; ?>" type="text" class="form-control form-control-sm" id="" name="" placeholder="">
            ...
            <div class="col-md-2">
              ...
              <div class="form-group">
                ...
                <select class="form-control form-control-sm" name="tipo_envio" id="tipo_envio">
                  ...
                  if (@$_GET['funcao'] == 'editar') {
                      $query = $pdo->query(
                          "SELECT * from tipo_envios where id = '$tipo_envio2' "
                      );
                      $res = $query->fetchAll(PDO::FETCH_ASSOC);
                      $nomeTipo = $res[0]['nome'];
                      echo "<option value='" .
                  ...
                  $query2 = $pdo->query(
                      'SELECT * from tipo_envios order by nome asc '
                  );
                  $res2 = $query2->fetchAll(PDO::FETCH_ASSOC);
                  for ($i = 0; $i < count($res2); $i++) {
                      foreach ($res2[$i] as $key => $value) {
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input value="<?php echo @$peso2; ?> Kg" type="text" class="form-control form-control-sm" id="peso" name="peso" placeholder="Peso em KG">
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label>Largura <small><small>(em Metros - Ex: 0.2 seria 20 cm)</small></small></label>
                <input value="<?php echo @$largura2; ?> m" type="text" class="form-control form-control-sm" id="largura" name="largura" placeholder="Largura">
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label>Altura <small><small>(em Metros - Ex: 0.2 seria 20 cm)</small></small></label>
                <input value="<?php echo @$altura2; ?> m" type="text" class="form-control form-control-sm" id="altura" name="altura" placeholder="Altura">
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label>Comprimento <small><small>(em Metros - Ex: 0.2 seria 20 cm)</small></small></label>
                <input value="<?php echo @$comprimento2; ?> m" type="text" class="form-control form-control-sm" id="comprimento" name="comprimento" placeholder="Comprimento">
          ...
          <div class="row">
            ...
            <div class="col-md-2">
              <div class="form-group">
                ...
                <input value="R$ <?php echo @$valor_frete2; ?>" type="text" class="form-control form-control-sm" id="valor-frete" name="valor-frete" placeholder="Valor Fixo Frete">
            ...
            <div class="col-md-5">                
              <div class="form-group">
                <input type="hidden" id="txtid22" name="txtid22" value="<?php echo @$_GET[
                  'id'
                ]; ?>">
                <label class="mt-4">Selecione uma Características</label>
              </div>
              
              
              <form method="post" id="form-carac2">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Característica</label>
                        <select class="form-control form-control-sm" name="caract-novo" id="caract-novo">
                         <?php
                          $query2 = $pdo->query(
                              'SELECT * from carac order by nome asc '
                          );
                          $res2 = $query2->fetchAll(PDO::FETCH_ASSOC);
                          for ($i = 0; $i < count($res2); $i++) {
                              foreach ($res2[$i] as $key => $value) {
                    ...
                    <div class="col-md-6" id="listar-carac2"></div>
                </div>

                <small>
                <div id="mensagem_carac2" class=""></div>
                </small>
                ...
                <button type="button" id="btn-add-carac2" value="<?php echo @$_GET[
                    'id'
                ]; ?>" name="btn-add-caraC2" class="btn btn-info">Adicionar Características</button>
                <!-- </div> -->
        </form>           
          </div>
            ...
            <div id="mensagem_carac" class="">
             ...
             <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal" id="btn-cancelar-carac">Cancelar</button>
                <input type="hidden" id="txtid" name="txtid" value="<?php echo @$_GET[
                    'id'
                ]; ?>">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="post" id="form-item-listar">
          <input type="hidden" name="id_carac_item_3" id="id_carac_item_3">
          <a id="btn-item-listar" name="btn-item-listar">
          </a>
        </form>
        ...
        <form method="post" id="form-item">
          <div class="row">
            <div class="col-md-4">
              ...
              <div class="form-group">
                <label for="cor">Selecione uma cor:<small>Se tiver cor</small></label>
              <input type="color"  class="form-control" id="valor-item" name="valor-item">
                
              </div>
              <div class="form-group">
                <label>Estoque</label>
                <input value="" type="text" class="form-control" id="estoque-item" name="estoque-item" placeholder="Quantidade em estoque">
              </div>
            </div>
            

            <div class="col-md-7" id="listar-itens">
      ...
      <div class="modal-footer">
        ...
        <input type="hidden" name="id_carac_item" id="id_carac_item" value="<?php echo @$_GET[
            'id'
        ]; ?>" >
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h6>Deseja realmente Excluir este Item?</h6>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        $id_pro = @$_GET['id'];
        $res = $pdo->query(
            "SELECT * FROM promocoes where id_produto = '$id_pro'"
        );
        ...
        if (@count($dados) > 0) {
            ...
            $editar = 'sim';
            $texto_promocao =
                'Valor Promocional deste Produto - ' . $valor_promo;
        } else {
            $editar = 'não';
            $data_ini = $agora;
            $data_fin = $agora;
      ...
      <div class="modal-footer">
        ...
        <input type="hidden" name="id-promocao" id="id-promocao" value="<?php echo @$_GET[
            'id'
        ]; ?>">
...
<form id="form" action="segunda-modal.php" method="post">
...
<!--AJAX PARA INSERÇÃO E EDIÇÃO DOS DADOS COM IMAGEM IMAGENS ADICIONAIS -->
<script type="text/javascript">
  $("#form-fotos").submit(function() {
    ...
    // var da urloriginal da imagem
    var urlImagemOriginal = "../../img/produtos/detalhes/sem-foto.jpg";
    // Obtém a tag img
    var img = document.getElementById("targetImgProduto");
    ...
    $.ajax({
      ...
      success: function(mensagem) {
        ...
        if (mensagem.trim() == "Salvo com Sucesso!!") {
          ...
          // Atualiza a tag img com a URL da imagem original
          img.src = urlImagemOriginal;
...
<!-- <script type="text/javascript">
  function listarCarac2() {
    var pag = "<?= $pag ?>";
    
    $.ajax({
      url: pag + "/listar-carac-modal-prod.php",
      method: "post",
      data: $('#form-carac2').serialize(),
      dataType: "html",
      success: function(result) {
...
<!-- ATUALIZAR A PAGINA PRODUTOS APOS EXCLUIR E FECHAR A MODAR CARACTERISTICAS -->
<script>
 
 $('#modal-carac').on('hidden.bs.modal', function (e) {
  var pag = "<?= $pag ?>";
  $.ajax({
    //  url: "index.php",
    success: function(){
      $('#myModal').modal('hide');
      window.location.replace('index.php?pag=produtos');
    }
  });
});
...
<!--SCRIPT QUE É EXECUTADO AO CARREGAR A PÁGINA - LISTAR SUBCATEGORIA-->
<script type="text/javascript">
  $(document).ready(function() {
    listarImagensProd();
    listarCarac();
...
<script type="text/javascript">
  $('#btn-add-carac2').click(function(event) {
    event.preventDefault();       
    var pag = "<?= $pag ?>";
   
    
    $.ajax({
      url: pag + "/add-carac2.php",
      method: "post",
      data: {'txtid-novo':$(this).val(),'caract-novo':$('#caract-novo').val()},
      dataType: "text",
      success: function(msg) {
        if (msg.trim() === 'Salvo com Sucesso!!') {

          $('#mensagem_carac2').addClass('text-success')
          $('#mensagem_carac2').text(msg);
          listarCarac();
          // abrir modal adicionar item

        } else {
          $('#mensagem_carac2').addClass('text-danger')
          $('#mensagem_carac2').text(msg);
