...
<div class="row mt-4 mb-4">
  ...
  <a type="button" class="btn-primary btn-sm ml-3 d-none d-md-block" href="index.php?pag=<?php echo $pag; ?>&funcao=novo">Novo Produto em Promoção</a>
  <a type="button" class="btn-primary btn-sm ml-3 d-block d-sm-none" href="index.php?pag=<?php echo $pag; ?>&funcao=novo">+</a>

</div>

<div class="titulo-pagina">
  <h5><?php echo 'Todos os '.$pag. ' em promoção' ?></h5>
  </div>
    ...
    <div class="table-responsive">
      <table class="w3-table-all w3-hoverable table table-striped table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
          ...
          <?php
          $query = $pdo->query("SELECT * FROM produtos WHERE promocao = 'Sim' order by id desc ");
      ...
      <form id="form" method="POST">
        <div class="modal-body">
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              <input type="text" id="txtid22" name="txtid22" value="<?php echo @$_GET[
                  'id'
              ]; ?>">
          ...
          <div class="row">
            ...
            <div class="col-md-6" id="listar-carac2">
