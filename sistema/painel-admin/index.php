...
$query = $pdo->query(
    "SELECT * FROM produtos where estoque <= '$nivel_estoque' order by estoque asc "
);
$res = $query->fetchAll(PDO::FETCH_ASSOC);
if (@count($res) > 0) {
    $classe_estoque = 'bg-danger';
} else {
    $classe_estoque = '';
}

//verificar se tem carrinho abandonado
$query5 = $pdo->query(
    "SELECT * FROM carrinho where id_venda = '0' "
);
$res5 = $query5->fetchAll(PDO::FETCH_ASSOC);
if (@count($res5) > 0) {
    $classe_carrinho = 'bg-dark text-light';
} else {
    $classe_carrinho = '';
}
...
if (@count($res) == 0) {
    $pdo->query(
        "INSERT INTO envios_email (data, final, assunto, mensagem, link) values (curDate(), '0', '', '', '') "
    );
}
...
$menu14 = 'blog';
$menu15 = 'banner';
$menu16 = 'produtos-promocao';
$menu17 = 'carrinho_abandonado';
...
$res = $pdo->query(
    "SELECT * FROM promocoes where ativo = 'Sim' and data_inicio <= curDate() and data_final >= curDate() "
);
$dados = $res->fetchAll(PDO::FETCH_ASSOC);
...
//SCRIPT PARA VERIFICAR OS PRODUTOS TEM VARIACAO
$pdo->query("UPDATE produtos SET variavel = 'Não' ");
$res = $pdo->query('SELECT * FROM carac_prod where id_carac > 0 ');
$dados = $res->fetchAll(PDO::FETCH_ASSOC);
for ($i = 0; $i < count($dados); $i++) {
    foreach ($dados[$i] as $key => $value) {
    }
    $id_pro2 = @$dados[$i]['id_prod'];

    $pdo->query("UPDATE produtos SET variavel = 'Sim' where id = $id_pro2");
}
?>
...
<body id="page-top " >
        ...
        <ul class=" navbar-nav bg-gradient-primary sidebar sidebar-dark " id="accordionSidebar" >
            ...
            <li class="nav-item ">
                ...
                <div id="collapseTwo" class="collapse  " aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded " id="navbarNavDropdown">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="index.php?pag=<?php echo $menu16; ?>">Produtos em Promoção</a>
            ...
            <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item <?php echo $classe_estoque; ?>">
                            <a class="nav-link" href="index.php?pag=<?php echo $menu13; ?>">
                                <i class="fas fa-minus-circle <?php echo $classe_estoque; ?>"></i>
                                <span >Estoque Baixo</span></a>
                            </li>
                            <li class="nav-item <?php echo $classe_carrinho; ?>">
                            <a class="nav-link" href="index.php?pag=<?php echo $menu17; ?>">
                                <i class="fas fa fa-shopping-cart <?php echo $classe_carrinho; ?>"></i>
                                <span >Carrinho Abandonado</span></a>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <!-- Content Wrapper -->
                                        <div id="content-wrapper" class="row d-flex flex-column l">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                        <ul id="lista-modais">
                        <li id="nome-pagina">Notificações</li>
                        </ul>
                        </li>
                    </ul>
                        ...
                        <div class="col">
                            <div class="row">
                                <div class="col-5 d-flex justify-content-center">
                                    <img src="../../img/logo.png" id="imgLogoAgente" style="max-width: 200px; max-height: 80px;" />
                                </div>
                            
                                <button class="w3-button btn-black w3-border w3-border-red w3-round-large mr-1 d-none d-md-block"><a class="nav-link" href="index.php">Dashboard</a></button>
                                <button class="   d-block d-sm-none btn-lg"><a class="nav-link" href="index.php">D</a></button>
                                
                                <button type="button" class="btn btn-primary btn-lg btn-sm ml-3 d-none d-md-block"><a class="nav-link" href="../../index.php" target="_blank"></a>Ver Loja Vitual</button>
                                <button type="button" class="btn btn-primary btn-sm ml-3 d-block d-sm-none  btn-lg badge-light"><a class="nav-link" href="../../index.php" target="_blank">Loja</a></button>
                                                ...
                                                <ul class="navbar-nav ml-auto ">
                                                    ...
                                                    <li class="nav-item dropdown no-arrow nav-item">
                                                        <a class="nav-link dropdown-toggle" href="#" id="" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            <span class="mr-3 d-none d-lg-inline text-gray-900 ">
                                                            <i class="fas fa-bars mr-2 text-primary"></i>
                                                                
                                                            </span>

                                                        </a>
                                                        <!-- Dropdown - User Information -->
                                                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in collapse" aria-labelledby="userDropdown">
                                                            <a class="dropdown-item nav-item" href="" data-toggle="modal" data-target="#ModalPerfil">
                                                                <i class="fas fa-user fa-sm fa-fw mr-2 text-primary"></i>
                                                                Dashboard
                                                            </a>

                                                            <a class="dropdown-item nav-item " href="" data-toggle="modal" data-target="#ModalConfig">
                                                    ...
                                                    <li class="nav-item dropdown no-arrow nav-item">
                                                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            <span class="mr-3 d-none d-lg-inline text-gray-900 "><?php echo @$nome_usu; ?></span>
    ...
    <div class="container">
        <div class="notice-section-wrapper  bg-white pt-2">
            <marquee behavior="scroll" direction="left" onmouseover="this.stop()" onmouseout="this.start()">
                <span class="px-4"><b>Noticias sobre alguma notificacao.:&nbsp;</b>CLique aqui para ser redirecionado ao item da notificacao</span>
            </marquee>
        </div>
    </div>
</section>
                                    ...
                                    <!--  Modal Perfil-->
                                    <div class="modal fade" id="ModalPerfil" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" name="Perfil" aria-hidden="true">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <input value="<?php echo $_SESSION[
                                            'id_usuario'
                                        ]; ?>" type="hidden" name="txtid" id="txtid">
                                        <input value="<?php echo $_SESSION[
                                            'cpf_usuario'
                                        ]; ?>" type="hidden" name="antigo" id="antigo">
                    ...
                    <!--  Modal Email-->
                    <div class="modal fade" id="ModalEmail" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" name="Email">
                            ...
                            <div class="modal-content">
                                ...
                                <form id="form-perfil" method="POST" enctype="multipart/form-data">
                                    <div class="modal-body">
                                        ...
                                        <?php
                                        $query = $pdo->query(
                                            "SELECT * FROM emails where ativo = 'Sim' "
                                        );
                                        $res = $query->fetchAll(
                                            PDO::FETCH_ASSOC
                                        );
                    ...
                    <!--  Modal Rel Mov-->
                    <div name="Vendas" class="modal fade" id="RelVendas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input value="<?php echo date(
                                                    'Y-m-d'
                                                ); ?>" type="date" class="form-control"  name="dataInicial" >
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                ...
                <!--  Modal Config-->
                <div class="modal fade" id="ModalConfig" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" name="Configurações" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
    ...
    <div class="col-md-3">
      <div class="form-group">
        ...
        <select class="form-control" name="mao_propria" id="mao_propria">
            <option <?php if (
                $mao_propria == 'N'
            ) { ?> selected <?php } ?> value="N">Não</option>
            <option <?php if (
                $mao_propria == 'S'
            ) { ?> selected <?php } ?> value="S">Sim</option>                               
...
<div class="col-md-3">
  <div class="form-group">
    ...
    <select class="form-control" name="valor_declarado" id="valor_declarado">
        <option <?php if (
            $valor_declarado == '0'
        ) { ?> selected <?php } ?> value="0">Não</option>
        <option <?php if (
            $valor_declarado == '1'
        ) { ?> selected <?php } ?> value="1">Sim</option>                               
...
<div class="col-md-3">
  <div class="form-group">
    ...
    <select class="form-control" name="formato_frete" id="formato_frete">
        <option <?php if (
            $formato_frete == '1'
        ) { ?> selected <?php } ?> value="1">Caixa / Pacote</option>
        <option <?php if (
            $formato_frete == '2'
        ) { ?> selected <?php } ?> value="2">Rolo / Prisma</option>         

        <option <?php if (
            $formato_frete == '3'
        ) { ?> selected <?php } ?> value="3">Envelope</option>                           
...
<!-- SCRIPT PARA MOSTRAR O MENU AO PASSARO MOUSE -->


    <script>
  $(document).ready(function() {
    // quando o mouse passa sobre o item do menu, adiciona a classe 'show' ao submenu
