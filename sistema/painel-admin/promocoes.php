...
<div class="titulo-pagina">
  <h5><?php echo 'Todos as promoções'?></h5>
  </div>
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><a href = "index.php?pag=<?php echo $pag ?>&funcao=editar&id=<?php echo $id ?>" class='text-primary mr-1' title='Editar Dados'><img src="../../img/promocoes/<?php echo $imagem ?>" width="80" height="50"></a></td>
