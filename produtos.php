...
<section class="product spad">
        ...
        <div class="sidebar">
          <div class="sidebar__item">
            ...
            <ul>
              <?php
              $query = $pdo->query(
                  'SELECT * FROM sub_categorias order by nome asc '
              );
          ...
          <div class="latest-product__text">
            ...
            <div class="latest-product__slider owl-carousel">
              <div class="latest-prdouct__slider__item">
                ...
                <?php
                $query = $pdo->query(
                    "SELECT * FROM produtos where ativo = 'Sim' and estoque > 0 order by id desc limit 6 "
                );
                $res = $query->fetchAll(PDO::FETCH_ASSOC);
              ...
              <div class="latest-prdouct__slider__item">
                ...
                <?php
                $query = $pdo->query(
                    "SELECT * FROM produtos where ativo = 'Sim' and estoque > 0 order by id desc limit 6,6 "
                );
                $res = $query->fetchAll(PDO::FETCH_ASSOC);
              ...
              <div class="latest-prdouct__slider__item">
                ...
                <?php
                $query = $pdo->query(
                    "SELECT * FROM produtos where ativo = 'Sim' and estoque > 0 order by id desc limit 12,6 "
                );
                $res = $query->fetchAll(PDO::FETCH_ASSOC);
          ...
          <div class="latest-product__text">
            ...
            <div class="latest-product__slider owl-carousel">
              ...
              <div class="latest-prdouct__slider__item">
                ...
                <?php
                $query = $pdo->query(
                    "SELECT * FROM combos where ativo = 'Sim' order by id desc limit 6 "
                );
                $res = $query->fetchAll(PDO::FETCH_ASSOC);
              ...
              <div class="latest-prdouct__slider__item">
                ...
                <?php
                $query = $pdo->query(
                    "SELECT * FROM combos where ativo = 'Sim' order by id desc limit 6,6 "
                );
                $res = $query->fetchAll(PDO::FETCH_ASSOC);
              ...
              <div class="latest-prdouct__slider__item">
                ...
                <?php
                $query = $pdo->query(
                    "SELECT * FROM combos where ativo = 'Sim'  order by id desc limit 12,6 "
                );
                $res = $query->fetchAll(PDO::FETCH_ASSOC);
      ...
      <div class="product__discount">
        ...
        <div class="row">
          <div class="product__discount__slider owl-carousel">
           ...
           <?php
           $query = $pdo->query(
               "SELECT * FROM produtos where promocao = 'Sim' and ativo = 'Sim' and estoque > 0"
           );
           $res = $query->fetchAll(PDO::FETCH_ASSOC);
  ...
  <div class="row">
   ...
   <?php
   $query = $pdo->query(
       "SELECT * FROM produtos where ativo = 'Sim' and estoque > 0 order by vendas desc limit 6"
   );
   $res = $query->fetchAll(PDO::FETCH_ASSOC);
  ...
  <?php
   ...
   ?>
    ...
    <div class="row">
     ...
     <?php
     $query = $pdo->query(
         "SELECT * FROM combos where ativo = 'Sim' order by vendas desc limit 6 "
     );
     $res = $query->fetchAll(PDO::FETCH_ASSOC);
