...
<div class="col-lg-9 col-md-7">
    ...
    <div class="row">
        ...
        <?php
        if(@$_GET['txtBuscar'] != "") {
            // seleciona aproximadamente o que foi digitado no campo buscar
        ...
        $query = $pdo->query("SELECT * FROM produtos where (nome LIKE '$buscar' or palavras like '$buscar' or sku like '$buscar') and ativo = 'Sim' order by id desc LIMIT $limite, $itens_por_pagina ");
...
<!-- se exitir uma buscar get no txttbuscar a paginacao nao aparece -->
<!-- PAGINADOR -->
