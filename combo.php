...
<?php //recuperar o nome do produto para filtrar os dados dele
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="product__details__text">
                    ...
                    <?php
                    $query = $pdo->query(
                        "SELECT * FROM prod_combos where id_combo = '$id_produto' "
                    );
                    $res = $query->fetchAll(PDO::FETCH_ASSOC);
                    ...
                    for ($i = 0; $i < count($res); $i++) {
                        ...
                        $query2 = $pdo->query(
                            "SELECT * FROM produtos where id = '$id_prod' "
                        );
                    ...
                    <!-- <img class=""
                        src="img/produtos/<?php echo $imagem; ?>" alt="" width="100" height="100"> -->
                    <?php } else { ?>
                  ...
                  <?php
                    ...
                    ?>
                       ...
                       if ($nome_frete == 'Valor Fixo') {
                           echo '<div class="product__details__text"><p>Frete Fixo de ' .
                               $valor_frete .
                               ' Reais</p>';
                       }
              ...
              <div class="col-lg-12">
                <div class="product__details__tab">
                    <ul class="nav nav-tabs" role="tablist">
                       ...
                       $query = $pdo->query(
                           "SELECT * FROM avaliacoes where id_produto = '$id_produto' "
                       );
                       $res = $query->fetchAll(PDO::FETCH_ASSOC);
                        ...
                        <div class="tab-pane" id="tabs-3" role="tabpanel">
                            ...
                            <div class="product__details__tab__desc">
                                ...
                                <div class="mt-2">
                                    ...
                                    <?php
                                    $query4 = $pdo->query(
                                        "SELECT * from avaliacoes where id_produto = '$id_produto' order by id desc"
                                    );
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="categories__slider owl-carousel">
                ...
                <?php
                $query = $pdo->query(
                    'SELECT * FROM combos order by id desc limit 10 '
                );
                $res = $query->fetchAll(PDO::FETCH_ASSOC);
