    ...
    <div class="row">
      ...
      <div class="hero__item set-bg bg-light" data-setbg="img/banner/<?php echo $imagem; ?>">
        <div class="hero__text">
          ...
          <a href="<?php echo $link; ?>" class="primary-btn"><?php echo mb_strToUpper(
    $textobt
); ?></a>
        </div>
      </div>
      ...
      <div class="col-lg-12">
       ...
       <div class="featured__controls">
        <ul>
         <?php
         $query = $pdo->query(
             'SELECT * FROM sub_categorias order by id limit 5 '
         );
         $res = $query->fetchAll(PDO::FETCH_ASSOC);
...
<div class="row featured__filter">
 ...
 <?php
 $query = $pdo->query(
     "SELECT * FROM produtos where ativo = 'Sim' and estoque > 0 order by vendas desc limit 8 "
 );
 $res = $query->fetchAll(PDO::FETCH_ASSOC);
 ...
 for ($i = 0; $i < count($res); $i++) {
     ...
     if ($promocao == 'Sim') {
         ...
         $queryp = $pdo->query(
             "SELECT * FROM promocoes where id_produto = '$id' "
         );
...
<!-- envia dados para adicionar ao carrinho -->
...
<div class="banner">
  <div class="container">
    <div class="row">
     ...
     <?php
     $query = $pdo->query(
         "SELECT * FROM promocao_banner where ativo = 'Sim' order by id desc limit 2 "
     );
     $res = $query->fetchAll(PDO::FETCH_ASSOC);
...
<!-- Latest Product Section Begin Produtos recentes -->
        ...
        <div class="latest-product__text">
          ...
          <div class="latest-product__slider owl-carousel">
            ...
            <div class="latest-prdouct__slider__item">
              ...
              <?php
              $query = $pdo->query(
                  "SELECT * FROM produtos where ativo = 'Sim' and estoque > 0 order by id desc limit 3,3 "
              );
              $res = $query->fetchAll(PDO::FETCH_ASSOC);
            ...
            <div class="latest-prdouct__slider__item">
              ...
              <?php
              $query = $pdo->query(
                  "SELECT * FROM produtos where ativo = 'Sim' and estoque > 0 order by id desc limit 6,3 "
              );
              $res = $query->fetchAll(PDO::FETCH_ASSOC);
...
<!-- Latest Product Section Begin Produtos recentes -->
          ...
          <div class="latest-product__slider owl-carousel">
            ...
            <div class="latest-prdouct__slider__item">
              ...
              <?php
              $query = $pdo->query(
                  "SELECT * FROM produtos where ativo = 'Sim' and estoque > 0 order by vendas desc limit 3 "
              );
              $res = $query->fetchAll(PDO::FETCH_ASSOC);
            ...
            <div class="latest-prdouct__slider__item">
              ...
              <?php
              $query = $pdo->query(
                  "SELECT * FROM produtos where ativo = 'Sim' and estoque > 0 order by vendas desc limit 3,3 "
              );
              $res = $query->fetchAll(PDO::FETCH_ASSOC);
            ...
            <div class="latest-prdouct__slider__item">
              ...
              <?php
              $query = $pdo->query(
                  "SELECT * FROM produtos where ativo = 'Sim' and estoque > 0 order by vendas desc limit 6,3 "
              );
              $res = $query->fetchAll(PDO::FETCH_ASSOC);
...
<!-- Latest Product Section Begin Produtos recentes -->
          ...
          <div class="latest-product__slider owl-carousel">
            ...
            <div class="latest-prdouct__slider__item">
              ...
              <?php
              $query = $pdo->query(
                  "SELECT * FROM combos where ativo = 'Sim' order by id desc limit 3 "
              );
              $res = $query->fetchAll(PDO::FETCH_ASSOC);
            ...
            <div class="latest-prdouct__slider__item">
              ...
              <?php
              $query = $pdo->query(
                  "SELECT * FROM combos where ativo = 'Sim' order by id desc limit 3,3 "
              );
              $res = $query->fetchAll(PDO::FETCH_ASSOC);
            ...
            <div class="latest-prdouct__slider__item">
              ...
              <?php
              $query = $pdo->query(
                  "SELECT * FROM combos where ativo = 'Sim' order by id desc limit 6,3 "
              );
              $res = $query->fetchAll(PDO::FETCH_ASSOC);
